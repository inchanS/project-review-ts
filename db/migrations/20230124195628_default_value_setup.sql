...
INSERT INTO categories(id, category, description) VALUES (4, '생활용품', '가구, 주방용품, 화장품, 잡화 등');
INSERT INTO categories(id, category, description) VALUES (5, '화장품', '화장품, 향수, 뷰티 등');
INSERT INTO categories(id, category, description) VALUES (6, '컨텐츠', '영화, 드라마, 음악, 책, 만화, 이벤트 등');
INSERT INTO categories(id, category, description) VALUES (7, '여행', '여행, 관광지, 호텔, 숙박시설 등');
INSERT INTO categories(id, category, description) VALUES (8, '기타', '기타');
